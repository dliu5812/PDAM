...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False, is_source=True):
    ...
    if is_source:
        dataset_list = cfg.DATASETS.TRAIN_SOURCE if is_train else cfg.DATASETS.TEST
    else:
